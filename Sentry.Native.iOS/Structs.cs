...
namespace Sentry.Native.iOS
{

	[Native]
	public enum SentryLogLevel : long
	{
		None = 1,
		Error,
		Debug,
	...
	[Native]
	public enum SentrySessionStatus : ulong
	{
		Ok = 0,
		Exited = 1,
		Crashed = 2,
